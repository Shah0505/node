...
var readFileData = fs.readFileSync(process.argv[2]); // read the file sync and store its value 

var lines = readFileData.toString().split('\n'); // convert the file into string and then split each new line
